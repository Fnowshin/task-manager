            ...
            <div className="mx-auto mt-24 w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
                ...
                <form onSubmit={handleLogin} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        <input type="text" name="email" id="username" placeholder="Email" className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-green-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={handleGoogleSignIn} type='submit' aria-label="Log in with Google" className="p-3 rounded-sm">
